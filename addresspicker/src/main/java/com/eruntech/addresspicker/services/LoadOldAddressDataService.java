 ...
 */
public class LoadOldAddressDataService {
    ...
    public LoadOldAddressDataService(ChineseAddressPicker chineseAddressPicker) {
    ...
    public void startToParseData() {
        new GetAddressDataAsyncTask().execute("address_data_old.xml");
    }
